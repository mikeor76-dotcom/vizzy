...
const SHEET_SPECS = {
  ...
  skyDragon: { mode: "sheet", w: 94, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  pirateShip: { mode: "sheet", w: 75, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  witchBroom: { mode: "sheet", w: 79, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  wingedShadow: { mode: "sheet", w: 93, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  bicycleRider: { mode: "sheet", w: 77, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  spyRope: { mode: "sheet", w: 36, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  meteorCassette: { mode: "sheet", w: 140, h: 74, frames: 1, anchor: "bottom", colors: 40 },
  ...
  giantCreature: { mode: "sheet", w: 90, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  dinosaur: { mode: "sheet", w: 80, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  robotDuo: { mode: "sheet", w: 81, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  glamGuitarist: { mode: "sheet", w: 65, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  keyboardPlayer: { mode: "sheet", w: 75, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  tinyDrummer: { mode: "sheet", w: 68, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  craneKick: { mode: "sheet", w: 78, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  maskedShadow: { mode: "sheet", w: 61, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  detectiveRain: { mode: "sheet", w: 59, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  steamTrain: { mode: "sheet", w: 111, h: 78, frames: 1, anchor: "bottom", colors: 40 },
  ballroomWindow: { mode: "sheet", w: 77, h: 78, frames: 1, anchor: "bottom", colors: 40 },
