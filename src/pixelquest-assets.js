...
export const ASSET_MANIFEST = {
  ...
  skyDragon: { src: "skyDragon.png", frameW: 78, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  pirateShip: { src: "pirateShip.png", frameW: 72, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  witchBroom: { src: "witchBroom.png", frameW: 103, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  wingedShadow: { src: "wingedShadow.png", frameW: 66, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  bicycleRider: { src: "bicycleRider.png", frameW: 79, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  spyRope: { src: "spyRope.png", frameW: 29, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "top-center", scale: 1, piSafe: true, fallback: "procedural" },
  meteorCassette: { src: "meteorCassette.png", frameW: 94, frameH: 74, anims: { idle: { frames: [0] } }, anchor: "center", scale: 1, piSafe: true, fallback: "procedural" },
  ...
  giantCreature: { src: "giantCreature.png", frameW: 156, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  dinosaur: { src: "dinosaur.png", frameW: 278, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  robotDuo: { src: "robotDuo.png", frameW: 140, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  glamGuitarist: { src: "glamGuitarist.png", frameW: 121, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  keyboardPlayer: { src: "keyboardPlayer.png", frameW: 147, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  tinyDrummer: { src: "tinyDrummer.png", frameW: 162, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  craneKick: { src: "craneKick.png", frameW: 130, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  maskedShadow: { src: "maskedShadow.png", frameW: 120, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  detectiveRain: { src: "detectiveRain.png", frameW: 121, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  steamTrain: { src: "steamTrain.png", frameW: 200, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
  ballroomWindow: { src: "ballroomWindow.png", frameW: 140, frameH: 78, anims: { idle: { frames: [0] } }, anchor: "bottom-center", scale: 1, piSafe: true, fallback: "procedural" },
